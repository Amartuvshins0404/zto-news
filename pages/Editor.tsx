...
import { 
  ...
  Image as ImageIcon, Table as TableIcon, Minus, Eye, Edit3, Upload, 
  AlignLeft, AlignCenter, AlignRight, AlignJustify,
  CheckSquare, Code, Highlighter, Underline as UnderlineIcon, Link as LinkIcon,
  Type, Youtube
} from 'lucide-react';
...
const MenuBar = ({ editor, openMediaLibrary }: { editor: any, openMediaLibrary: () => void }) => {
  ...
  return (
    <>
      <div className="border-b border-gray-200 dark:border-gray-700 p-2 bg-white dark:bg-neutral-dark sticky top-0 z-10 flex flex-wrap gap-1 items-center">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-dark">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-6 sticky top-20 z-20 bg-gray-50 dark:bg-neutral-dark py-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            {isPreview ? (
               ...
               <div className="bg-white dark:bg-neutral-dark shadow-sm border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden min-h-[80vh] flex flex-col">
                  {isVoices ? (
          ...
          <div className="space-y-6">
             <div className="bg-white dark:bg-neutral-dark p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 sticky top-24">
